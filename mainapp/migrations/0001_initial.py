# Generated by Django 4.0.5 on 2022-06-01 17:54
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('additional', models.ManyToManyField(blank=True, related_name='additional_from', to='mainapp.food', verbose_name='Дополнительные товары')),
                ('category', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='food', to='mainapp.foodcategory', verbose_name='Раздел меню')),
            ],
            options={
                'abstract': False,
            },
